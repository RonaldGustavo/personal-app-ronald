...
const CarouselIcon = () => (
  <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
    ...
    <path strokeLinecap="round" d="M15 9l3 3-3 3" />
    <path strokeLinecap="round" d="M9 9l-3 3 3 3" />
  </svg>
);
  ...
  return (
    <div className="px-6 md:px-16 pt-20 md:pt-16 pb-16">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Section header */}
        <header className="mb-8 flex items-end justify-between" data-aos="fade-up">
          <div>
        ...
        {/* ── Desktop: grid view (all projects) ── */}
        {isGridView && (
          <div className="hidden md:grid grid-cols-2 lg:grid-cols-3 gap-5" data-aos="fade-up">
            {PROJECTS_DATA.map((proj, i) => (
              <a
                key={proj.title}
                href={proj.url}
                ...
                data-aos="fade-up"
                data-aos-delay={i * 60}
                className="flex flex-col bg-white/5 border border-white/10 rounded-2xl p-5 hover:border-purple-500/50 hover:bg-white/[0.08] transition-all duration-200 group"
              >
                <h3 className="text-base font-bold text-white mb-2 group-hover:text-purple-300 transition-colors">
                  {proj.title}
                </h3>
        ...
        <div className={`hidden ${isGridView ? '' : 'md:block'}`} data-aos="fade-up">
